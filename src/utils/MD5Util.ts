 ...
 * @Project  XDDAgent
 */
function MD5Util (string: string) {
  function md5RotateLeft (lValue: any, iShiftBits: any) {
    return (lValue << iShiftBits) | (lValue >>> (32 - iShiftBits))
  }
  function md5AddUnsigned (lX: any, lY: any) {
  ...
  function md5F (x: any, y: any, z: any) {
    return (x & y) | ((~x) & z)
  }
  function md5G (x: any, y: any, z: any) {
    return (x & z) | (y & (~z))
  }
  function md5H (x: any, y: any, z: any) {
    return (x ^ y ^ z)
  }
  function md5I (x: any, y: any, z: any) {
    return (y ^ (x | (~z)))
  }
  function md5FF (a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = md5AddUnsigned(a, md5AddUnsigned(md5AddUnsigned(md5F(b, c, d), x), ac))
    return md5AddUnsigned(md5RotateLeft(a, s), b)
  }
  function md5GG (a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = md5AddUnsigned(a, md5AddUnsigned(md5AddUnsigned(md5G(b, c, d), x), ac))
    return md5AddUnsigned(md5RotateLeft(a, s), b)
  }
  function md5HH (a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = md5AddUnsigned(a, md5AddUnsigned(md5AddUnsigned(md5H(b, c, d), x), ac))
    return md5AddUnsigned(md5RotateLeft(a, s), b)
  }
  function md5II (a: any, b: any, c: any, d: any, x: any, s: any, ac: any) {
    a = md5AddUnsigned(a, md5AddUnsigned(md5AddUnsigned(md5I(b, c, d), x), ac))
    return md5AddUnsigned(md5RotateLeft(a, s), b)
  }
  function md5ConvertToWordArray (string: any) {
    var lWordCount
  ...
  function md5WordToHex (lValue: any) {
    var WordToHexValue = ''
  ...
  function md5Utf8Encode (string: any) {
